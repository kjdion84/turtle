...
Route::group(['middleware' => 'web'], function () {
    ...
    Route::get('billing/plan/{key}', config('turtle.controllers.auth') . '@billingPlanModal')->name('billing.plan');
    Route::post('billing/plan/{key}', config('turtle.controllers.auth') . '@billingPlan');
